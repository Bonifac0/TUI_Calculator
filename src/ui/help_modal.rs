...
pub fn render(frame: &mut Frame, area: Rect) {
    ...
    let text = vec![
        ...
        Line::from("  • Left / Right / h/l: Move editing cursor"),
        Line::from("  • Up / Down / k/j   : Scroll 2D math canvas"),
        Line::from("  • Del               : Clear active expression"),
        Line::from("  • Shift+Del         : All Clear (Reset memory & variables)"),
